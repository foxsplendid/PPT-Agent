...
class OpenAIProvider(LLMProvider):
    ...
    def _build_chat_kwargs(
        ...
        *,
        ...
        # Xiaomi MiMo thinking models (e.g. mimo-v2.5-pro) enable reasoning
        # by default, which consumes the entire max_tokens budget on internal
        # reasoning and returns an empty content field. Disable it so the
        # final answer reliably appears in message.content.
        if self._provider_name == "xiaomi":
